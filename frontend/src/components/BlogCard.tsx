...
const BlogCard = ({
  ...
  return (
    <div className="p-4 pb-4 border-slate-200 border-b-2">
      <div className="flex my-2 items-center">
        ...
        <div className="text-sm pl-1 font-light text-slate-600">{publishedDate}</div>
      </div>
      <div className="font-semibold">{title}</div>
      <div className="text-md font-thin">{content.slice(0, 100) + "..."}</div>
      <div className="ml-1 text-slate-500 mt-4 pb-4 text-sm font-extrathin">
      <span className="px-1 text-[4px] align-middle text-slate-600">&#9679;</span>
